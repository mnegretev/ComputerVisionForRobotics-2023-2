...
def main():
    img_blank  = numpy.zeros((512, 512, 3), numpy.uint8)    # Genera imagen negra
    img_blank[128:256,0:256] = 255*numpy.ones((128, 256, 3), numpy.uint8)   #un segmento de la matriz se llena de pixeles blancos?
